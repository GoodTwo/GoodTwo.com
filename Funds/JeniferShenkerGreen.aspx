<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="JeniferShenkerGreen.aspx.cs" Inherits="Funds_JeniferShenkerGreen" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div class="left">
        <div class="causeVideo">
          <iframe title="YouTube video player" class="youtube-player" type="text/html" width="391" height="313" src="http://www.youtube.com/embed/kJMY3achvvY" frameborder="0" allowfullscreen="allowFullScreen"></iframe>
      </div>
        <h3>
