<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="TNT_TravisYoung.aspx.cs" Inherits="Funds_tnt_travisyoung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="Server">
    <div id="header">
        ...
        <div id="causeIntro">
          ...
          <div id="titleline">
                    <h2>
                        2011 Boston Marathon Team in Training
</h2>
                    <h3>
                        Boston, MA</h3>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div class="left">
        ...
        <h3>
            Note from Travis Young</h3>
      <p>The Leukemia & Lymphoma Society's Team In Training (TNT) is the world's leading sports charity training program. TNT's dynamic, hands-on training program enables participants to realize their dream of completing a marathon, half marathon, triathlon, century ride or hike adventure. Each donation helps accelerate finding a cure for leukemia, lymphoma and myeloma.  Even if blood cancer is not something you've had direct experience with, cancer is something that impacts all of our lives and finding cures needs your support.
</p>
        <a href="http://pages.teamintraining.org/ma/boston11/tyoungpibd" target="_new" class="visitSite">visit website &raquo;</a>
        <div id="fb-root">
  </div>
            ...
            <li>
              <div>
                ...
                <p class="prices"> Price: $45<br />
                  Discount: 50%<br />
                  You Save: $90</p>
                <p class="buyNowHolder"> <a href="http://store.goodtwo.com/ShoppingCart.asp?ProductCode=TNT_TYoung_Toscana"
                ...
                <p class="description"> Located on Newbury Street, <strong>Toscana European Day Spa</strong> sits in a tranquil
                  ...
                  and talent back to the U.S., right here in Boston for your pleasure. <a href="http://store.goodtwo.com/ProductDetails.asp?ProductCode=TNT_TYoung_Toscana"
            ...
            <li>
              <div>
                ...
                <p class="prices"> Price: $10<br />
                  Discount: 50%<br />
                  You Save: $20</p>
                <p class="buyNowHolder"> <a href="http://store.goodtwo.com/ShoppingCart.asp?ProductCode=TNT_TYoung_Rubins"
                ...
                <p class="description"> Located at 500 Harvard Street in the heart of Brookline, <strong>Rubin's Kosher Restaurant
                  ...
                  and so much more at Rubin's! <a href="http://store.goodtwo.com/ProductDetails.asp?ProductCode=TNT_TYoung_Rubins"
                            target="_new">More Info</a></p>
                <table>
                  <tr>
                    <th> Rubin's Deli </th>
       ...
       <li>
         <div>
           ...
           <p class="prices"> Price: $20<br />
             Discount: 60%<br />
             You Save: $50</p>
           <p class="buyNowHolder"> <a href="http://store.goodtwo.com/ShoppingCart.asp?ProductCode=TNT_TYoung_GVannis"
           ...
           <p class="description"> Nestled in Boston's infamous North End sits <b>G'Vanni's Ristorante</b>, an inviting
             ...
             and mozzarella. <a href="http://store.goodtwo.com/ProductDetails.asp?ProductCode=TNT_TYoung_GVannis"
                            target="_new">More Info</a></p>
           <table>
             <tr>
