<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ElleBostonMarathon.aspx.cs" Inherits="Funds_ellebostonmarathon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="Server">
    <div id="header">
        ...
        <div id="causeIntro">
            <img src="../Images/ellemarathon.jpg" alt="Logo" />
            <div id="causeIntroContent">
          <div id="titleline">
                    <h2>
            Elle's Boston Marathon Fundraiser</h2>
                    <h3>
            Boston, MA</h3>
                </div>
                <p>This spring, I have a chance to cross something off my bucket list while making a difference in the community. Take the same opportunity to have a positive impact in a person's life that truly needs your help. With your help I can meet and exceed my goal. </p>
            </div>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div class="left">
        <div class="causeVideo"><img height="313" src="../Images/ellemarathon-main.jpg" alt="" /></div>
        <h3>
            Note from Emmanuelle Subar:</h3>
      <p>READY, SET, GO! On April 18, 2011, I will be running my very first marathon...The Boston Marathon. I have always dreamt of running the Boston Marathon, I even wrote it down on my bucket list years ago. As a soccer player, the marathon always seemed like something I would love to do but would never really get the chance to accomplish.</p>
      <p>This spring that all changes. TEAM CJP is giving me the opportunity to not only cross 'Run Boston Marathon' off my bucket list, they are giving me the opportunity to accomplish one of my goals while making a difference in the lives of people who need it most.</p>
      <p>The decision to run was not an easy one. As a working, second-year law student, I had to take into account whether I would really have the time to properly train. If it were just a marathon I probably would have said no. Free time is already a rare thing for me and training would take up a lot of free time. However, I cannot quite express my respect for an organization like CJP and how honored I feel representing them these next few months. With the opportunity to lend a hand to an organization rooted in compassion and justice and driven by innovation while inspiring each generation, there was no way I could turn this chance down.</p>
        <a href="http://www.cjp.org/teamcjp" target="_new" class="visitSite">visit website &raquo;</a>
        <div id="fb-root">
  </div>
        <script src="http://connect.facebook.net/en_US/all.js#appId=169884946376917&amp;xfbml=1"></script>
        <fb:comments xid="EllesBostonMarathon" numposts="10" width="370" publish_feed="true"></fb:comments>
    </div>
  <div class="right">
    ...
    <div class="howItWorks">
        ...
        <ul id="merchantList">
            <li>
              <div>
                ...
                <p class="prices"> Price: $15<br />
                  Discount: 50%<br />
                You Save: $15</p>
                <p class="buyNowHolder"> <a href="http://store.goodtwo.com/ShoppingCart.asp?ProductCode=ElleBosMara_Joses"
                            target="_new" class="buyNow">Buy Now</a> $3.75 will be donated to this cause</p>
                <p class="description"> Located in North Cambridge, <strong>Jose's </strong>prides itself on offering homemade cuisine that's been passed down through family generations. The owner was raised on home cooked food prepared from fresh local ingredients, so that's exactly what you're getting when you dine with Jose's! Munch on some <strong>salsa or guac &amp; chips</strong> as you take your time with their extensive yet oh so enticing menu. Dig into their <strong>chicken, shrimp, steak</strong> or <strong>veggie fajitas</strong> or infamous <strong>Mexican Flag Enchiladas</strong>, sporting their three colors with salsa, cheese, and tomatillo sauce. Craving something more traditional? Try something &quot;From My Mother's Kitchen&quot; like the <strong>Tamales del Dia</strong> with different fillings each day! Don't forget to dip into some dessert (like the homemade flan!) too! <a href="http://store.goodtwo.com/ProductDetails.asp?ProductCode=ElleBosMara_Joses"
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td><a href="http://maps.google.com/maps?client=safari&q=131+Sherman+Street,+Cambridge,+MA+02140&oe=UTF-8&ie=UTF8&hq=&hnear=131+Sherman+St,+Cambridge,+Middlesex,+Massachusetts+02140&gl=us&z=16" target="_new"> Map / Directions &raquo;</a></td>
                  </tr>
                  <tr>
           ...
           <p class="prices"> Price: $20<br />
             Discount: 60%<br />
             You Save: $30</p>
           <p class="buyNowHolder"> <a href="http://store.goodtwo.com/ShoppingCart.asp?ProductCode=ElleBosMara_GVannis"
           ...
           <p class="description"> Nestled in Boston's infamous North End sits <b>G'Vanni's Ristorante</b>, an inviting
             ...
             and mozzarella. <a href="http://store.goodtwo.com/ProductDetails.asp?ProductCode=ElleBosMara_GVannis"
                            target="_new">More Info</a></p>
           <table>
             <tr>
       ...
       <li>
          <div>
                ...
                <p class="prices"> Price: $45<br />
                  Discount: 50%<br />
                  You Save: $45</p>
                <p class="buyNowHolder"> <a href="http://store.goodtwo.com/ShoppingCart.asp?ProductCode=ElleBosMara_Toscana"
                ...
                <p class="description"> Located on Newbury Street, <strong>Toscana European Day Spa</strong> sits in a tranquil
                  ...
                  and talent back to the U.S., right here in Boston for your pleasure. <a href="http://store.goodtwo.com/ProductDetails.asp?ProductCode=ElleBosMara_Toscana"
                            target="_new">More Info</a></p>
                <table>
                  <tr>
