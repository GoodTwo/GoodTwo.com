    ...
    <div id="header">
        ...
        <div id="causeIntro">
            <div class="left" style="width: 180px">
                <img id="IntroFundLogo" style="vertical-align: top" runat="server" src="" alt="Logo"
                    clientidmode="Static" />
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="left">
        <div id="mediaSection" class="causeVideo" runat="server" clientidmode="Static">
            ...
            <img id="LeftPhoto" runat="server" class="resize" src="" alt="photo" clientidmode="Static"
                style="display: none" />
        </div>
        <h3>
            <span id="LeftCauseName" runat="server" clientidmode="Static"></span><asp:Literal ID="litTeamName" runat="server"></asp:Literal>
        </h3>
        <br />
        <p>
            <span id="LeftFundBody" runat="server" clientidmode="Static"></span>
        </p>
        <div id="LeftFundWebSite" runat="server">
        </div>
        <div id="fb-root">
        </div>
        <asp:Literal ID="litFBComments" runat="server"></asp:Literal>
    ...
    <div class="right">
        ...
        <div id="dealSummary">
            ...
            <ul class="shareCont">
                <li class="facebook"><asp:Literal ID="litFBLink" runat="server"></asp:Literal></li>
                <li class="twitter"><asp:Literal ID="litTwitterLink" runat="server"></asp:Literal></li>
                <li class="email">
                    <asp:Literal ID="litEmail" runat="server"></asp:Literal></li>
                <li class="likeButton">
        ...
        <div class="howItWorks">
            <p>
                <strong>Here's how it works:</strong> You save on deals from the merchants below
                and part of each purchase benefits this cause, it's a win - win situation for everyone.</p>
        </div>
        <div id="NoProduct">
