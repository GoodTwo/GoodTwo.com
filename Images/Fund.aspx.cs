...
public partial class Funds_Fund : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        IntroFundTagline.InnerHtml = Utils.ReplaceGarbageChars((String)rdr["Tagline"]);
        ...
        string causeName = Utils.ReplaceGarbageChars((String)rdr["CauseName"]);
        LeftCauseName.InnerHtml = causeName;
        LeftFundBody.InnerHtml = Utils.ReplaceGarbageChars((String)rdr["Body"]);
        ...
        try
        {
            ...
            if (selectedProductsList.Count > 0)
            {
                ...
                foreach (goodtooDraft.Products.xmldataProducts product in selectedProductsList) // For every product
                {
                    ...
                    if (!RenderLogic.AddProductListItem(ul, product, selectedProductsList[0].Equals(product), this.Page, true))
                        continue;
